// Shared social / UI icons. All use currentColor so they inherit text color.
...
// Central place for real handles — edit here, everything updates.
export const SOCIALS = [
  { name: 'GitHub', href: 'https://github.com/Its-darshu', Icon: GitHubIcon },
  { name: 'X', href: 'https://x.com/cookmithick', Icon: XIcon },
  { name: 'Discord', href: 'https://discord.com/users/darshan_66', Icon: DiscordIcon },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/in/darshanjocky/', Icon: LinkedInIcon },
  { name: 'Email', href: 'mailto:darshan99806@gmail.com', Icon: MailIcon },
];
